...
class _DocumentosPageState extends State<DocumentosPage> {
  ...
  // Query para pegar documentos do usuário por categoria
                  ...
                  Expanded(
                    child: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        if (docs.isEmpty) {
                          return Center(child: Text('Nenhum documento na categoria "$categoriaSelecionada".'));
                        }
                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return DocumentoCard(
                              ...
                              onDeleted: () async {
                                ...
                                if (confirm == true) {
                                  try {
                                    ...
                                    ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Documento excluído')));
                                  } catch (e) {
                              ...
                              onEdit: () async {
                                // Navega para tela de edição e espera retorno para atualizar a lista
      ...
      child: ListTile(
        ...
        trailing: Row(
          ...
          children: [
            ...
            IconButton(icon: const Icon(Icons.delete, color: Colors.redAccent), onPressed: onDeleted),
          ],
        ),
      ),
    );
